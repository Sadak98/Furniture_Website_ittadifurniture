...
<head>
    ...
    <title>Bedside Table Collections - Ityadi Furniture</title>
    ...
    <main class="container mt-0">
        ...
        <div class="row">
            ...
            $allData = mysqli_query($conn, "SELECT bedroom.*, bedroom_images.image_path
                                            ...
                                            WHERE bedroom.type='Bedside table' ORDER BY bedroom.id DESC");
            ...
            ?>
                ...
                <div class="col-6 col-md-3 mb-4">
                    <div class="card">
                        ...
                        <a href="product_details?type=bedroom&id=<?php echo $product['id']; ?>">
