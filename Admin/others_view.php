                ...
                <div class="container mt-4 mb-5">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT others.id, others.name, others.code, others.price, others.offer_price, others.type, MIN(others_images.image_path) AS image_path
                            FROM others
                            LEFT JOIN others_images ON others.id = others_images.furniture_id
                            GROUP BY others.id, others.name, others.code, others.price, others.offer_price, others.type";
