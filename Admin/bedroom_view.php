                ...
                <div class="container mt-4 mb-5">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT bedroom.id, bedroom.name, bedroom.code, bedroom.price, bedroom.offer_price, bedroom.type, MIN(bedroom_images.image_path) AS image_path
                            FROM bedroom
                            LEFT JOIN bedroom_images ON bedroom.id = bedroom_images.furniture_id
                            GROUP BY bedroom.id, bedroom.name, bedroom.code, bedroom.price, bedroom.offer_price, bedroom.type";
