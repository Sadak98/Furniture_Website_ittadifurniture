                ...
                <div class="container mt-4 mb-5">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT living.id, living.name, living.code, living.price, living.offer_price, living.type, MIN(living_images.image_path) AS image_path
                            FROM living
                            LEFT JOIN living_images ON living.id = living_images.furniture_id
                            GROUP BY living.id, living.name, living.code, living.price, living.offer_price, living.type";
