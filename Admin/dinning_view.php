                ...
                <div class="container mt-4 mb-5">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT dinning.id, dinning.name, dinning.code, dinning.price, dinning.offer_price, dinning.type, MIN(dinning_images.image_path) AS image_path
                            FROM dinning
                            LEFT JOIN dinning_images ON dinning.id = dinning_images.furniture_id
                            GROUP BY dinning.id, dinning.name, dinning.code, dinning.price, dinning.offer_price, dinning.type";
