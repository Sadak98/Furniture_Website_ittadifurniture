    ...
    <div class="container-fluid justify-content-center border-dark mt-5">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                //Blogs
                $blog = mysqli_query($conn, "SELECT id FROM blog_posts ORDER BY id");
                ...
                <div class="container">
                    ...
                    <h3 class="text-success text-center mt-3">Total Living Room Furniture</h3>
                    <div class="row">
                        <?php
                        // Define an array with furniture categories and their corresponding variables
                        $furnitureCategories = [
                    ...
                    <h3 class="text-success text-center mt-3">Total Reading Room Furniture</h3>
                    <div class="row">
                        <?php
                        // Define an array with furniture categories and their corresponding variables
                        $furnitureCategories = [
                    ...
                    <h3 class="text-success text-center mt-3">Total Dining Room Furniture</h3>
                    <div class="row">
                    <?php
                        // Define an array with furniture categories and their corresponding variables
                        $furnitureCategories = [
                   ...
                   <!-- Blog -->
                    ...
                    <h3 class="text-success text-center mt-3">Total Uploaded Blog</h3>
                    <div class="row">
                    <?php
                        // Define an array with furniture categories and their corresponding variables
                        $furnitureCategories = [
                            ['name' => 'Blog', 'count' => $Countblog ],
