                ...
                <div class="container mt-4 mb-5">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT office.id, office.name, office.code, office.price, office.offer_price, office.type, MIN(office_images.image_path) AS image_path
                            FROM office
                            LEFT JOIN office_images ON office.id = office_images.furniture_id
                            GROUP BY office.id, office.name, office.code, office.price, office.offer_price, office.type";
